"""
Django settings for utsprogramlanjut project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-a-hhl#0vqz+k&hg7wra6+$eqtpvar9&m31(cc_z8wr9+9wiz8n')
...
ROOT_URLCONF = 'utsprogramlanjut.urls'
...
WSGI_APPLICATION = 'utsprogramlanjut.wsgi.application'
