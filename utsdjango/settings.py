"""
Django settings for utsdjango project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-2s7b+usdosdel$8hp=*wu)_#rnav3a!efbq_xd5j+q+owf4jcf')
...
WSGI_APPLICATION = 'utsdjango.wsgi.application'
